        ...
        <div class="d-flex">
            <div class="text-secondary">
                ...
                <div class="ms-2 d-inline-block">
                    <input type="text" id="search-input" class="form-control form-control" aria-label="Search users" placeholder="Введите для поиска...">
                </div>
            </div>
            <a href="/user/add" class="btn btn-primary ms-auto">Добавить администратора</a>
        </div>
    </div>
        ...
        <table class="table card-table table-vcenter text-nowrap datatable">
            ...
            <tbody id="user-table">
                <?php foreach ($users as $user): ?>
                    <tr>
                        <td class="filterable"><?php echo $user['id']; ?></td>
                        <td class="filterable"><?php echo $user['username']; ?></td>
                        <td class="filterable"><?php echo $user['email']; ?></td>
                        <td class="filterable"><?php echo $user['name']; ?></td>
                        <td class="filterable">
                            <?php 
