...
<head>
    ...
    <title>BRB Оцените сотрудника<?php if (!empty($title)) echo (' | ' . $title) ?></title>
    ...
    <link rel="stylesheet" href="/views/layouts/rate/style.css">
</head>
...
<body>
    ...
    <script src="/views/layouts/rate/script.js"></script>
</body>
